package com.zing.dragSelection;
...
/**
 * Created by abhishek on 11/9/18.
 */
...
public class DragSelectionProcessor implements DragSelectTouchListener.OnAdvancedDragSelectListener {
    ...
    private ArrayList<String> mOriginalSelection;
    ...
    public void onSelectionStarted(int start) {
        mOriginalSelection = new ArrayList<>();
        ArrayList<String> selected = mSelectionHandler.getSelection();
        if (selected != null)
