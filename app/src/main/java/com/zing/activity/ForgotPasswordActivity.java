...
/**
 * Created by abhishek on 23/5/18.
 */
...
public class ForgotPasswordActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tvErrorDetail.setTypeface(AppTypeface.avenieNext_demibold);
    ...
    private void sendOtp() {
        ...
        try {
            ...
            jsonObject.setType("forgot-password");
                    ...
                    if (response.code() == 200) {
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                Intent intent = new Intent(ForgotPasswordActivity.this, VerifyNumberActivity.class);
